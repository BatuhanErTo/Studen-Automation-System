...
namespace Pusula.Student.Automation.Migrations
{
    ...
    [Migration("20251108180356_ChangeColumnNameGenderToEnumGender")]
    partial class ChangeColumnNameGenderToEnumGender
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pusula.Student.Automation.Courses.GradeComponent", b =>
                {
                    ...
                    b.Property<string>("GradeComponentName")
                        ...
                        .HasColumnName("GradeComponentName");
                    ...
                    b.ToTable("AppGradeComponents", (string)null);
                });

            modelBuilder.Entity("Pusula.Student.Automation.Departments.Department", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Pusula.Student.Automation.Enrollments.AttendanceEntry", b =>
                {
                    ...
                    b.ToTable("AppAttendanceEntries", (string)null);
                });
            ...
            modelBuilder.Entity("Pusula.Student.Automation.Enrollments.GradeEntry", b =>
                {
                    ...
                    b.ToTable("AppGradeEntries", (string)null);
                });
                    ...
                    b.OwnsOne("Pusula.Student.Automation.ValueObjects.TimeRange", "Time", b1 =>
                        {
                            ...
                            b1.HasKey("CourseSessionId");

                            b1.ToTable("AppCourseSessions");
            ...
            modelBuilder.Entity("Pusula.Student.Automation.Enrollments.AttendanceEntry", b =>
                {
                    b.HasOne("Pusula.Student.Automation.Courses.CourseSession", null)
                        .WithMany()
                        .HasForeignKey("CourseSessionId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("Pusula.Student.Automation.Enrollments.Enrollment", b =>
                {
                    ...
                    b.HasOne("Pusula.Student.Automation.Students.StudentEntity", null)
                        .WithMany()
